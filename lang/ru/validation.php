...
return [
    ...
    */
    ...
    'phone.exists' => 'Телефонный номер не зарегистрирован в приложении',
    ...
    'type_user_not_found' => 'Тип пользователя не найден',
    'validate_error' => 'Ошибка валидации',
    'group_user_not_found' => 'Группа пользователей не найдена',
];
